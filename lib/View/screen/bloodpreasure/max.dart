// ignore_for_file: sort_child_properties_last, prefer_const_constructors, unused_local_variable, prefer_typing_uninitialized_variables
...
class MaxScreen extends StatefulWidget {
  const MaxScreen({super.key});
  @override
  State<MaxScreen> createState() => _MaxScreenState();
}

class _MaxScreenState extends State<MaxScreen> {
  String dropdownValue = 'Week';
  @override
  void initState() {
    super.initState();
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      final maxBpProvier = Provider.of<MaxBpProvier>(context, listen: false);
      maxBpProvier.setMaxBp(context: context);
    });
  }
