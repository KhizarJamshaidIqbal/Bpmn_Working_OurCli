// ignore_for_file: sort_child_properties_last, prefer_const_constructors, unused_field
...
class _AverageScreenState extends State<AverageScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      final avgBpProvier = Provider.of<AvgBpProvier>(context, listen: false);
      avgBpProvier.setAvgBp(context: context);
    });
  }
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    FittedBox(
                                      fit: BoxFit.fitWidth,
                                      child: Consumer<AvgBpProvier>(
                                        builder: (context, value, child) {
                                          return Text(
                                            "${double.parse(((value.avgsys / value.avgdivideby)).toStringAsFixed(2))}",
                                            style: TextStyle(
                                                fontSize: 40,
                                                color:
