// ignore_for_file: sort_child_properties_last, prefer_const_constructors, use_build_context_synchronously, prefer_typing_uninitialized_variables, empty_catches, duplicate_ignore, use_full_hex_values_for_flutter_colors, unused_field, must_be_immutable, no_logic_in_create_state, sized_box_for_whitespace, avoid_print
...
class UpdateSuger extends StatefulWidget {
  String id;

  String time, date, mgddl;
  ...
  @override
  State<UpdateSuger> createState() =>
      _UpdateSugerState(id: id, time: time, mgddl: mgddl, date: date);
}

class _UpdateSugerState extends State<UpdateSuger> {
  String id;
  ...
  final mgDEditingController = TextEditingController();
  late var sugerProvider;
  @override
  void initState() {
    super.initState();
    formattedDate = date;
    formattedTime = time;
     mgDEditingController.text = mgddl;
  }
                ...
                child: ElevatedButton(
                  onPressed: () async {
                    if (_formKey.currentState!.validate()) {
                      ...
                      await SugerServices.updateItem(
                          sugerFormData, id.toString());
                      selectedSateProvider.clearlist();
                      final allitems = await SugerServices.getItems();
                      for (var item in allitems) {
                        selectedSateProvider.setSugerList(item);
                      }
